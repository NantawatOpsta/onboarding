...
เริ่มใช้ Docker กับ Django อย่างง่ายดาย
...
# สร้างโปรเจค Django ชื่อ firstproject ในโฟลเดอร์ source
docker run --rm --user 1000 -v $(pwd)/source:/app django django-admin startproject firstproject .
...
- เริ่มทำตาม [Django Tutorial](https://docs.djangoproject.com/en/6.0/intro/tutorial01/) เพื่อเรียนรู้การพัฒนาเว็บแอปพลิเคชันด้วย Django เพิ่มเติม
...
- สรุปสิ่งที่ได้เรียนรู้จากการทดลองครั้งนี้
